    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            penerimaanstokgudang
          </h1>
          <ol class="breadcrumb">
            <li><i class="fa fa-columns"></i> penerimaanstokgudang</li>
          </ol>
        </section>
              ...
              <div class="box">
				...
				<a href="#"><button class="btn btn-success" type="button" data-target="#ModalAdd" data-toggle="modal"><i class="fa fa-plus"></i> Add</button></a>
				  ...
				  <table id="data" class="table table-bordered table-striped table-scalable">
					<thead>
					<tr>
						<th>Kode penerimaanstokgudang</th>
						<th>id_jenis</th>
						<th>id_gudang</th>
						<th>jumlah</th>
						<th>tgl_terima</th>
				...
				<tbody>
					<?php
						$qpnsgdg = mysqli_query ($konek, "SELECT * FROM tb_penerimaanstokgudang WHERE id_admin=".$_SESSION["id_admin"]."");
						if($qpnsgdg == false){
						...
						while ($respnsgdg = mysqli_fetch_array ($qpnsgdg)){
							...
							echo "
								<tr>
									...
									<td>$respnsgdg[id_jenis]</td>
									<td>$respnsgdg[id_gudang]</td>
									<td>$respnsgdg[jumlah]</td>
									<td>$respnsgdg[tgl_terima]</td>
									<td>
									...
									<div class="input-group">
										...
										<?php
											...
											while ($jenis = mysqli_fetch_array($queryjenis)){
												echo "<option value='$jenis[id_jns]'>$jenis[nm_jenis]</option>";
											}
										?>
										</select>
									</div>
									...
									<div class="input-group">
										...
										<?php
											...
											while ($gudang = mysqli_fetch_array($querygudang)){
												echo "<option value='$gudang[id_gdg]'>$gudang[nm_gudang]</option>";
											}
										?>
										</select>
									</div>
