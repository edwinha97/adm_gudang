...
$querypenerimaanstok_gudang = mysqli_query($konek, "SELECT * FROM tb_penerimaanstokgudang WHERE id_pnsgdg='$id_pnsgdg'");
						 	...
						 	<div class="form-group">
								<label>Tanggal Terima</label>
									<div class="input-group date">
										...
										<input id="tgl_terima" name="tgl_terimabr" type="text" class="form-control" value="<?php echo $penerimaanstok_gudang["tgl_terima"]; ?>">
									</div>
							</div>
							<div class="form-group">
